...
//             _staffController = new StaffController(_staffService.Object);
//         }

//         [Fact]
//         public async Task Create_WithValidDto_ShouldReturnStaffDto()
//         {
//             // Arrange
//             var dto = new StaffDto { Id = "N2024000001", FullName = "John Doe" };
//             _staffService.Setup(s => s.AddAsync(dto)).ReturnsAsync(dto);
...
//         [Fact]
//         public async Task GetGetById_WithExistingId_ShouldReturnStaffDto()
//         {
//             // Arrange
//             var staffId = "N2024000001";
//             var staff = new StaffDto { Id = staffId, FullName = "John Doe" };
//             _staffService.Setup(s => s.GetByIdAsync(new StaffId(staffId))).ReturnsAsync(staff);

//             // Act
//             var result = await _staffController.GetGetById(staffId);
...
//         [Fact]
//         public async Task Update_WithValidDto_ShouldReturnUpdatedStaffDto()
//         {
//             // Arrange
//             var dto = new EditingStaffProfileDto { Id = "N2024000001", FullName = "Jane Doe" };
//             var updatedStaff = new StaffDto { Id = dto.Id, FullName = dto.FullName };
//             _staffService.Setup(s => s.UpdateAsync(dto)).ReturnsAsync(updatedStaff);

//             // Act
//             var result = await _staffController.Update(dto, new StaffId(dto.Id));

//             // Assert
//             var actionResult = Assert.IsType<ActionResult<StaffDto>>(result);
//             var okResult = Assert.IsType<OkObjectResult>(actionResult.Result);
//             var returnValue = Assert.IsType<StaffDto>(okResult.Value);
//             Assert.Equal("Jane Doe", returnValue.FullName);
//         }
...
//             var staffId = "N2024000001";
//             var staff = new StaffDto { Id = staffId, FullName = "John Doe" };
//             _staffService.Setup(s => s.DeleteAsync(new StaffId(staffId))).ReturnsAsync(staff);

//             // Act
//             var result = await _staffController.Delete(staffId);
...
//         [Fact]
//         public async Task GetAll_ShouldReturnListOfStaffDto()
//         {
//             // Arrange
//             var staffList = new List<StaffDto>
//             {
//                 new StaffDto { Id = "N2024000001", FullName = "John Doe" },
//                 new StaffDto { Id = "N2024000002", FullName = "Jane Smith" }
//             };
//             _staffService.Setup(s => s.GetAllAsync()).ReturnsAsync(staffList);

//             // Act
//             var result = await _staffController.GetAll();
...
//             Assert.Equal(2, ((List<StaffDto>)returnValue).Count);
//         }
//     }
// }
